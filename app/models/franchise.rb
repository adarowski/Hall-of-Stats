...
class Franchise < ActiveHash::Base
  ...
  add id: 'mia', name: 'Miami Marlins', active: true, img: 'ramirha01', img_credit: 'http://www.flickr.com/photos/dirkhansen/3745568888/', player: 'Hanley Ramirez', first_year: '1993', note: 'Also played as Florida Marlins.', color: '#F46634'
  ...
  add id: 'tbr', name: 'Tampa Bay Rays', active: true, img: 'priceda01', img_credit: 'http://www.flickr.com/photos/keithallison/2881485220/', player: 'David Price', first_year: '1998', note: 'Also played as Tampa Bay Devil Rays.', color: '#00285D'
  ...
  add id: 'beg', name: 'Baltimore Elite Giants', first_year: '1930', last_year: '1948'
  add id: 'br2', name: 'Brooklyn Royal Giants', first_year: '1923', last_year: '1927'
  add id: 'cag', name: 'Chicago American Giants', first_year: '1920', last_year: '1948'
  add id: 'cbb', name: 'Columbus Blue Birds', first_year: '1933', last_year: '1933'
  add id: 'cbe', name: 'Cleveland Buckeyes', first_year: '1942', last_year: '1948'
  add id: 'cbn', name: 'Cleveland Browns', first_year: '1924', last_year: '1924'
  add id: 'ccu', name: 'Cleveland Cubs', first_year: '1931', last_year: '1931'
  add id: 'cel', name: 'Cleveland Elites', first_year: '1926', last_year: '1926'
  add id: 'cg', name: 'Cleveland Giants', first_year: '1933', last_year: '1933'
  add id: 'cht', name: 'Cleveland Hornets', first_year: '1927', last_year: '1927'
  add id: 'cl2', name: 'Cleveland Stars', first_year: '1932', last_year: '1932'
  add id: 'cob', name: 'Columbus Buckeyes', first_year: '1921', last_year: '1921'
  add id: 'cog', name: 'Chicago Giants', first_year: '1920', last_year: '1921'
  add id: 'cot', name: 'Columbus Turfs', first_year: '1932', last_year: '1932'
  add id: 'crs', name: 'Cleveland Red Sox', first_year: '1934', last_year: '1934'
  add id: 'cse', name: 'Cuban Stars East I', first_year: '1923', last_year: '1929'
  add id: 'csw', name: 'Cuban Stars West', first_year: '1920', last_year: '1930'
  add id: 'ct', name: 'Cincinnati Tigers', first_year: '1937', last_year: '1937'
  add id: 'ctg', name: 'Cleveland Tigers', first_year: '1928', last_year: '1928'
  add id: 'cts', name: 'Cleveland Tate Stars', first_year: '1922', last_year: '1922'
  add id: 'cup', name: 'Pollock’s Cuban Stars', first_year: '1932', last_year: '1932'
  add id: 'ds', name: 'Detroit Stars I', first_year: '1920', last_year: '1931'
  add id: 'dts', name: 'Detroit Stars II', first_year: '1937', last_year: '1937'
  add id: 'dw', name: 'Detroit Wolves', first_year: '1932', last_year: '1932'
  add id: 'dym', name: 'Dayton Marcos', first_year: '1920', last_year: '1926'
  add id: 'hbg', name: 'Harrisburg Giants', first_year: '1924', last_year: '1927'
  add id: 'hg', name: 'Homestead Grays', first_year: '1929', last_year: '1948'
  add id: 'hil', name: 'Hilldale Club', first_year: '1923', last_year: '1932'
  add id: 'ia', name: 'Indianapolis Athletics', first_year: '1937', last_year: '1937'
  add id: 'ic', name: 'Indianapolis Clowns', first_year: '1943', last_year: '1948'
  add id: 'jrc', name: 'Jacksonville Red Caps', first_year: '1938', last_year: '1942'
  add id: 'kcm', name: 'Kansas City Monarchs', first_year: '1920', last_year: '1948'
  add id: 'lrg', name: 'Little Rock Grays', first_year: '1932', last_year: '1932'
  add id: 'lvb', name: 'Louisville Black Caps', first_year: '1930', last_year: '1932'
  add id: 'mb', name: 'Milwaukee Bears', first_year: '1923', last_year: '1923'
  add id: 'mgs', name: 'Montgomery Grey Sox', first_year: '1932', last_year: '1932'
  add id: 'mrm', name: 'Monroe Monarchs', first_year: '1932', last_year: '1932'
  add id: 'mrs', name: 'Memphis Red Sox', first_year: '1924', last_year: '1948'
  add id: 'nby', name: 'New York Black Yankees', first_year: '1936', last_year: '1948'
  add id: 'nd', name: 'Newark Dodgers', first_year: '1934', last_year: '1935'
  add id: 'ne', name: 'Newark Eagles', first_year: '1935', last_year: '1948'
  add id: 'nlg', name: 'New York Lincoln Giants', first_year: '1923', last_year: '1929'
  add id: 'ns', name: 'Newark Stars', first_year: '1926', last_year: '1926'
  add id: 'nwb', name: 'Newark Browns', first_year: '1932', last_year: '1932'
  add id: 'nyc', name: 'New York Cubans', first_year: '1935', last_year: '1948'
  add id: 'pbg', name: 'Philadelphia Bacharach Giants', first_year: '1934', last_year: '1934'
  add id: 'pbk', name: 'Pittsburgh Keystones II', first_year: '1922', last_year: '1922'
  add id: 'pc', name: 'Pittsburgh Crawfords', first_year: '1933', last_year: '1940'
  add id: 'ps', name: 'Philadelphia Stars', first_year: '1934', last_year: '1948'
  add id: 'ptg', name: 'Philadelphia Tigers', first_year: '1928', last_year: '1928'
  add id: 'sen', name: 'Washington Black Senators', first_year: '1938', last_year: '1938'
  add id: 'sl2', name: 'St. Louis Stars II', first_year: '1937', last_year: '1937'
  add id: 'sls', name: 'St. Louis Stars I', first_year: '1920', last_year: '1931'
  add id: 'snh', name: 'St. Louis-New Orleans-Harrisburg Stars', first_year: '1938', last_year: '1943'
  add id: 'tt', name: 'Toledo Tigers', first_year: '1923', last_year: '1923'
  add id: 'wap', name: 'Washington Pilots', first_year: '1932', last_year: '1932'
  add id: 'wp', name: 'Washington Potomacs', first_year: '1924', last_year: '1925'
end
