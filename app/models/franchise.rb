...
class Franchise < ActiveHash::Base
  ...
  add id: 'min', name: 'Minnesota Twins', active: true, img: 'mauerjo01.jpg', img_credit: 'http://www.flickr.com/photos/keithallison/2312029414/in/photostream/', player: 'Joe Mauer', first_year: '1901'
