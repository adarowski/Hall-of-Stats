...
class Franchise < ActiveHash::Base
  ...
  add id: 'ana', name: 'Los Angeles Angels of Anaheim', active: true, img: 'troutmi01.jpg', img_credit: 'http://www.flickr.com/photos/keithallison/7458320456/', player: 'Mike Trout', first_year: '1961', note: 'Also played as Anaheim Angels, California Angels, and Los Angeles Angels.', color: '#CE1141'
  add id: 'ari', name: 'Arizona Diamondbacks', active: true, img: 'johnsra05.jpg', img_credit: 'http://en.wikipedia.org/wiki/File:Randy_Johnson_04.jpg', player: 'Randy Johnson', first_year: '1998', color: '#C51230'
  add id: 'ath', name: 'Philadelphia Athletics', first_year: '1876', last_year: '1876'
  add id: 'atl', name: 'Atlanta Braves', active: true, img: 'jonesch01.jpg', img_credit: 'http://www.flickr.com/photos/keithallison/3620680381/', player: 'Chipper Jones', first_year: '1876', note: 'Also played as Milwaukee Braves, Boston Braves, Boston Bees, Boston Rustlers, Boston Doves, Boston Beaneaters, and Boston Red Stockings.', color: '#01487E'
  add id: 'bal', name: 'Baltimore Orioles', active: true, img: 'wietema01.jpg', img_credit: 'http://www.flickr.com/photos/keithallison/5709564672/', player: 'Matt Wieters', first_year: '1901', note: 'Also played as St. Louis Browns and Milwaukee Brewers.', color: '#DF4601'
  ...
  add id: 'bos', name: 'Boston Red Sox', active: true, img: 'pedrodu01.jpg', img_credit: 'http://www.flickr.com/photos/keithallison/2492970513/', player: 'Dustin Pedroia', first_year: '1901', note: 'Also played as Boston Americans.', color: '#BD3039'
  ...
  add id: 'chc', name: 'Chicago Cubs', active: true, img: 'castrst01.jpg', img_credit: 'http://www.flickr.com/photos/12154815@N04/8037926942/', player: 'Starlin Castro', first_year: '1876', note: 'Also played as Chicago Orphans, Chicago Colts, and Chicago White Stockings.', color: '#D12325'
  ...
  add id: 'chw', name: 'Chicago White Sox', active: true, img: 'konerpa01.jpg', img_credit: 'http://www.flickr.com/photos/keithallison/7896985130/', player: 'Paul Konerko', first_year: '1901', color: '#000000'
  add id: 'cin', name: 'Cincinnati Reds', active: true, img: 'vottojo01.jpg', img_credit: 'http://www.flickr.com/photos/keithallison/5874694122/in/photostream/', player: 'Joey Votto', first_year: '1882', note: 'Also played as Cincinnati Redlegs and Cincinnati Red Stockings.', color: '#EB184B'
  add id: 'ckk', name: 'Cincinnati Kelly’s Killers', first_year: '1891', last_year: '1891'
  add id: 'cle', name: 'Cleveland Indians', active: true, img: 'lofton.jpg', img_credit: 'http://www.flickr.com/photos/andrewmalone/1959551785/', player: 'Kenny Lofton', first_year: '1901', note: 'Also played as Cleveland Naps, Cleveland Bronchos, and Cleveland Blues.', color: '#023465'
  ...
  add id: 'col', name: 'Colorado Rockies', active: true, img: 'heltoto01.jpg', img_credit: 'http://www.flickr.com/photos/dirkhansen/3738116090/', player: 'Todd Helton', first_year: '1993', color: '#333366'
  ...
  add id: 'det', name: 'Detroit Tigers', active: true, img: 'verlaju01.jpg', img_credit: 'http://www.flickr.com/photos/keithallison/7578597412/', player: 'Justin Verlander', first_year: '1901', color: '#10293F'
  ...
  add id: 'fla', name: 'Miami Marlins', active: true, img: 'ramirha01.jpg', img_credit: 'http://www.flickr.com/photos/dirkhansen/3745568888/', player: 'Hanley Ramirez', first_year: '1993', note: 'Also played as Florida Marlins.', color: '#00A5B1'
  ...
  add id: 'hou', name: 'Houston Astros', active: true, img: 'berkmla01.jpg', img_credit: 'http://www.flickr.com/photos/ableman/152833858/', player: 'Lance Berkman', first_year: '1962', note: 'Also played as Houston Colt .45’s.', color: '#95322C'
  ...
  add id: 'kcr', name: 'Kansas City Royals', active: true, img: 'greinza01.jpg', img_credit: 'http://www.flickr.com/photos/keithallison/3770512483/', player: 'Zack Greinke', first_year: '1969', color: '#000572'
  ...
  add id: 'lad', name: 'Los Angeles Dodgers', active: true, img: 'kempma01.jpg', img_credit: 'http://www.flickr.com/photos/dirkhansen/6007960724/', player: 'Matt Kemp', first_year: '1884', color: '#005596'
  ...
  add id: 'mil', name: 'Milwaukee Brewers', active: true, img: 'braunry02.jpg', img_credit: 'http://www.flickr.com/photos/stoshpaparazzo/8268424583/', player: 'Ryan Braun', first_year: '1969', note: 'Also played as Seattle Pilots.', color: '#012143'
  add id: 'min', name: 'Minnesota Twins', active: true, img: 'mauerjo01.jpg', img_credit: 'http://www.flickr.com/photos/keithallison/2312029414/', player: 'Joe Mauer', first_year: '1901', note: 'Also played as Washington Senators.', color: '#042462'
  ...
  add id: 'nym', name: 'New York Mets', active: true, img: 'wrighda01.jpg', img_credit: 'http://www.flickr.com/photos/keithallison/3639903545/', player: 'David Wright', first_year: '1962', color: '#F7742C'
  ...
  add id: 'nyy', name: 'New York Yankees', active: true, img: 'canoro01.jpg', img_credit: 'http://www.flickr.com/photos/keithallison/7968125548/', player: 'Robinson Cano', first_year: '1901', note: 'Also played as New York Highlanders and Baltimore Orioles.', color: '#132448'
  add id: 'oak', name: 'Oakland Athletics', active: true, img: 'cespeyo01.jpg', img_credit: 'http://www.flickr.com/photos/keithallison/7672898350/', player: 'Yoenis Cespedes', first_year: '1901', note: 'Also played as Kansas City Athletics and Philadelphia Athletics.', color: '#00483A'
  ...
  add id: 'phi', name: 'Philadelphia Phillies', active: true, img: 'utleych01.jpg', img_credit: 'http://www.flickr.com/photos/imatty35/7696038442/', player: 'Chase Utley', first_year: '1883', note: 'Also played as Philadelphia Quakers.', color: '#CA1F2C'
  ...
  add id: 'pit', name: 'Pittsburgh Pirates', active: true, img: 'mccutan01.jpg', img_credit: 'http://www.flickr.com/photos/keithallison/7369332444/', player: 'Andrew McCutchen', first_year: '1882', note: 'Also played as Pittsburgh Alleghenys.', color: '#FFB40B'
  ...
  add id: 'sdp', name: 'San Diego Padres', active: true, img: 'hoffmtr01.jpg', img_credit: 'http://www.flickr.com/photos/dirkhansen/2814118351/', player: 'Trevor Hoffman', first_year: '1969', color: '#1C3465'
  add id: 'sea', name: 'Seattle Mariners', active: true, img: 'suzukic01.jpg', img_credit: 'http://www.flickr.com/photos/keithallison/5712089370/', player: 'Ichiro', first_year: '1977', color: '#003166'
  add id: 'sfg', name: 'San Francisco Giants', active: true, img: 'bondsba01.jpg', img_credit: 'http://www.flickr.com/photos/kevinrushforth/225833857/', player: 'Barry Bonds', first_year: '1883', note: 'Also played as New York Giants and New York Gothams.', color: '#FB5B1F'
  ...
  add id: 'stl', name: 'St. Louis Cardinals', active: true, img: 'carpech01.jpg', img_credit: 'http://www.flickr.com/photos/keithallison/8075839055/', player: 'Chris Carpenter', first_year: '1882', note: 'Also played as St. Louis Perfectos, St. Louis Browns, and St. Louis Brown Stockings.', color: 'C41E3A'
  ...
  add id: 'tbd', name: 'Tampa Bay Rays', active: true, img: 'priceda01.jpg', img_credit: 'http://www.flickr.com/photos/keithallison/2881485220/', player: 'David Price', first_year: '1998', note: 'Also played as Tampa Bay Devil Rays.', color: '#00285D'
  add id: 'tex', name: 'Texas Rangers', active: true, img: 'hamiljo01.jpg', img_credit: 'http://www.flickr.com/photos/keithallison/7156380592/', player: 'Josh Hamilton', first_year: '1961', note: 'Also played as Washington Senators.', color: '#01317B'
  ...
  add id: 'tor', name: 'Toronto Blue Jays', active: true, img: 'bautijo02.jpg', img_credit: 'http://www.flickr.com/photos/keithallison/6019208107/', player: 'Jose Bautista', first_year: '1977', color: '#0067A6'
  ...
  add id: 'wsn', name: 'Washington Nationals', active: true, img: 'harpebr01.jpg', img_credit: 'http://www.flickr.com/photos/keithallison/7436455670/', player: 'Bryce Harper', first_year: '1969', note: 'Also played as Montreal Expos.', color: '#14225A'
