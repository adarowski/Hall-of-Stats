...
class Franchise < ActiveHash::Base
  ...
  add id: 'atl', name: 'Atlanta Braves', active: true, img: 'jonesch01', img_credit: 'http://www.flickr.com/photos/keithallison/3620680381/', player: 'Chipper Jones', first_year: '1876', note: 'Also played as Milwaukee Braves, Boston Braves, Boston Bees, Boston Rustlers, Boston Doves, Boston Beaneaters, and Boston Red Stockings.', color: '#01487E'
  ...
  add id: 'cin', name: 'Cincinnati Reds', active: true, img: 'vottojo01', img_credit: 'http://www.flickr.com/photos/keithallison/5874694122/in/photostream/', player: 'Joey Votto', first_year: '1882', note: 'Also played as Cincinnati Redlegs and Cincinnati Red Stockings.', color: '#EB184B'
  add id: 'ckk', name: 'Cincinnati Kelly’s Killers', first_year: '1891', last_year: '1891'
  add id: 'cle', name: 'Cleveland Indians', active: true, img: 'lofton', img_credit: 'http://www.flickr.com/photos/andrewmalone/1959551785/', player: 'Kenny Lofton', first_year: '1901', note: 'Also played as Cleveland Naps, Cleveland Bronchos, and Cleveland Blues.', color: '#023465'
  ...
  add id: 'nym', name: 'New York Mets', active: true, img: 'wrighda01', img_credit: 'http://www.flickr.com/photos/keithallison/3639903545/', player: 'David Wright', first_year: '1962', color: '#F7742C'
  ...
  add id: 'tex', name: 'Texas Rangers', active: true, img: 'hamiljo01', img_credit: 'http://www.flickr.com/photos/keithallison/7156380592/', player: 'Josh Hamilton', first_year: '1961', note: 'Also played as Washington Senators.', color: '#01317B'
  ...
  add id: 'wsn', name: 'Washington Nationals', active: true, img: 'harpebr01', img_credit: 'http://www.flickr.com/photos/keithallison/7436455670/', player: 'Bryce Harper', first_year: '1969', note: 'Also played as Montreal Expos.', color: '#14225A'
